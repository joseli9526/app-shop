                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="info">
                                ...
                                <h4 class="info-title">Atendemos tus deudas</h4>
                        ...
                        <div class="col-md-4">
                            <div class="info">
                                ...
                                <p>Los pedidos que realices sólo los conocerás tú a través de tu panel de usuario. Nadie más tiene acceso a esa información</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="section landing-section">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <h4 class="text-center description">Registrate ingresando tus datos básicos y podrás realizar tus pedidos a través de nuestro carrito de compras.</h4>
