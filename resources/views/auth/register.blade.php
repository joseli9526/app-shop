                        ...
                        <form class="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="content">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="email" type="email"  placeholder="Correo electronico" class="form-control" name="email"
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="phone" type="phone"  placeholder="Teléfono" class="form-control" name="phone"
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="address" type="text"  placeholder="Dirección" class="form-control" name="address"
